...
#define NUM_ELEMENTS 6978
    ...
    void main(void)
    {
       ...
       i2c_init();                              // Initialize I2C
             send = 0;
       i2c_tx(MPU6050_ADDR, &send, 1, ONEBYTEADDR, MPU6050_PWR_MGMT_1, 0x00);// Address is High byte then low byte
       while (1)
       {

    	   i2c_rx(MPU6050_ADDR, &Xout, 1,ONEBYTEADDR,0x3B,0x00);//i2c RX 115 bytes from EEPROM starting @ address 01:00
    	   _delay_cycles(1000);
if(Xout>220)
{
	P1OUT |= LED0;
